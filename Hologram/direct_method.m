function reconstruction = direct_method(hologram, a11, a22, b11, b22, d11, d22, period_x, period_y)
...
Chirp2 = exp(1i*pi*(  ((x*(1/(width_x*b11))).^2)*(d11/b11) +  ((y*(1/(width_y*b22))).^2)*(d22/b22)));
